...
const NFTCollectionBg = ({ contractAddress }) => {
  ...
  return (
    ...
    >
      {
        <div
          className="nft-collection-header-cover-overlay"
          style={{ filter: `opacity(${showOverlay ? "1" : "0"})` }}
        >
          <label
            className="nft-collection-header-cover-overlay-upload-label"
          ...
          <input
            className="nft-collection-header-cover-overlay-upload-input"
            type="file"
